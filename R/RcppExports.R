...
#' elementMetadata(pv)
#'
pqsfinder <- function(subject, strand = "*", overlapping = FALSE, max_len = 50L, min_score = 31L, run_min_len = 2L, run_max_len = 11L, loop_min_len = 0L, loop_max_len = 30L, max_bulges = 3L, max_mismatches = 3L, max_defects = 3L, tetrad_bonus = 40L, mismatch_penalty = 29L, edge_mismatch_penalty = 27L, bulge_penalty = 21L, bulge_len_factor = 0.7, bulge_len_exponent = 0.8, loop_mean_factor = 4.5, loop_mean_exponent = 1, run_re = ".?G{1,10}.{0,9}G{1,10}.?", custom_scoring_fn = NULL, use_default_scoring = TRUE, verbose = FALSE) {
