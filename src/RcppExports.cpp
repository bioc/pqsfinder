...
// pqsfinder
SEXP pqsfinder(SEXP subject, std::string strand, bool overlapping, int max_len, int min_score, int run_min_len, int run_max_len, int loop_min_len, int loop_max_len, int max_bulges, int max_mismatches, int max_defects, int tetrad_bonus, int bulge_penalty, int mismatch_penalty, double loop_mean_factor, double loop_mean_exponent, double loop_sd_factor, std::string run_re, SEXP custom_scoring_fn, bool use_default_scoring, bool verbose);
